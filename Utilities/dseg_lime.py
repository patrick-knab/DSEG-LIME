...
class DSEG_Lime(object):
    ...
    def explain_instance(self, 
        ...
        for iter in range(iterations):
            ...
            top_labels_list = ret_exp.local_exp[ret_exp.top_labels[0]][0:self.num_features_explanation]
        return ret_exp
    ...
    def segment_seed_dynamic(self, 
        ...
        if not sam_model:
            ...
            resized_panoptic_seg_mask = self.create_mask_sam(resized_panoptic_seg_, hierarchical_dict, iteration = 0, seeds = [])
    ...
    def create_mask_sam(self, sam_mask_raw, hierarchical_dict, iteration = 0, seeds = None):
